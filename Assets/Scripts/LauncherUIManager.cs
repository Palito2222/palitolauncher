...
public class LauncherUIManager : MonoBehaviour
{
    ...
    public LocalizedString update;
    public LocalizedString play;
    public LocalizedString downloading;
    public LocalizedString unziping;
    public LocalizedString gameVersion;
    public LocalizedString errorCode;
    ...
    {
        // Obtener la configuración regional del sistema operativo
        System.Globalization.CultureInfo culture = System.Globalization.CultureInfo.CurrentCulture;

        // Convertir la configuración regional en un SystemLanguage de Unity
        // Aquí se mapea una lista de configuraciones regionales a los idiomas de Unity
    ...
    void UpdateGlobalStringReferenceValue(string variableName)
    {
        ...
        // Aquí es donde cambias el LocalizedString en el LocalizeStringEvent
    ...
    private IEnumerator DownloadFile(string url, string filePath, string zipFileName)
    {
        ...
        if (www.result == UnityWebRequest.Result.Success)
        {
            ...
            else
            {
                ...
                if (!File.Exists(downloadPath))
                {
                    buttonText.text = unziping.GetLocalizedString();
